...
$pdf->SetFont('Times','',10);
    ...
    if($date_from!='' ||$date_to!='')
	{
    	$filter.=" and ";
     	if($date_from!='' && $date_to!='')
            $filter.=" date_released >= '".date("Y-m-d",strtotime($date_from))." 00:00:00' and date_released <='".date("Y-m-d",strtotime($date_to))." 23:59:59'";
     	else if($date_from!='')
           $filter.=" date_released like '".date("Y-m-d",strtotime($date_from))."%' ";
     	else
           $filter.=" date_released like '".date("Y-m-d",strtotime($date_to))."%' ";
	}
